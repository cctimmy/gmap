...
*/
export const isEqual = <T extends { [key: string]: string | number }>(o1: T, o2: T, ignoreKeys: string[] = []) =>
    !Object.keys(o2)
 ...
 */
export const getDiff = <T extends { [key: string]: string | number }>(aList: T[], bList: T[], idKey: string) => {
